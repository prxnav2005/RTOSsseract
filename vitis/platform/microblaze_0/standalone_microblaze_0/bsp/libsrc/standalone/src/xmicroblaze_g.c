...
XMicroblaze_Config XMicroblaze_ConfigTable[] __attribute__ ((section (".drvcfg_sec"))) = {
	{
		...
		0x40,  /* d-cache-line-size */
		0x0,  /* xlnx,dcache-always-used */
		0x4000,  /* d-cache-size */
		0x40,  /* i-cache-line-size */
		0x4000,  /* i-cache-size */
		0x1,  /* xlnx,addr-tag-bits */
		...
		0x1,  /* xlnx,i-lmb */
		 0,  /* xlnx,i-opb */
		 0,  /* xlnx,i-plb */
		0x1,  /* xlnx,dcache-addr-tag */
		0x4000,  /* xlnx,dcache-byte-size */
		0x10,  /* xlnx,dcache-line-len */
		...
		0xc0003fff,  /* d-cache-highaddr */
		0xc0000000,  /* i-cache-baseaddr */
		0xc0003fff,  /* i-cache-highaddr */
