...
#ifndef _RTOS_Block_microblaze_0_xlconcat_0_core_h_
#define _RTOS_Block_microblaze_0_xlconcat_0_core_h_
...
class RTOS_Block_microblaze_0_xlconcat_0_core : public sc_module 
{
    public: 
       RTOS_Block_microblaze_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(RTOS_Block_microblaze_0_xlconcat_0_core);
    ...
    virtual ~RTOS_Block_microblaze_0_xlconcat_0_core() = default;
