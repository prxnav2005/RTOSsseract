...
// Command     : write_verilog -force -mode synth_stub -rename_top RTOS_Block_microblaze_0_axi_periph_imp_auto_ds_4 -prefix
//               RTOS_Block_microblaze_0_axi_periph_imp_auto_ds_4_ RTOS_Block_microblaze_0_axi_periph_imp_auto_ds_4_stub.v
...
(* CHECK_LICENSE_TYPE = "RTOS_Block_microblaze_0_axi_periph_imp_auto_ds_4,axi_dwidth_converter_v2_1_35_top,{}" *) (* CORE_GENERATION_INFO = "RTOS_Block_microblaze_0_axi_periph_imp_auto_ds_4,axi_dwidth_converter_v2_1_35_top,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_dwidth_converter,x_ipVersion=2.1,x_ipCoreRevision=35,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=artix7,C_AXI_PROTOCOL=0,C_S_AXI_ID_WIDTH=1,C_SUPPORTS_ID=0,C_AXI_ADDR_WIDTH=14,C_S_AXI_DATA_WIDTH=64,C_M_AXI_DATA_WIDTH=32,C_AXI_SUPPORTS_WRITE=1,C_AXI_SUPPORTS_READ=1,C_FIFO_MODE=0,C_S_AXI_ACLK_RATIO=1,C_M_AXI_ACLK_RATIO=2,C_AXI_IS_ACLK_ASYNC=0,C_MAX_SPLIT_BEATS=256,C_PACKING_LEVEL=1,C_SYNCHRONIZER_STAGE=3}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "axi_dwidth_converter_v2_1_35_top,Vivado 2024.2.2" *) 
module RTOS_Block_microblaze_0_axi_periph_imp_auto_ds_4(s_axi_aclk, s_axi_aresetn, s_axi_awaddr, 
