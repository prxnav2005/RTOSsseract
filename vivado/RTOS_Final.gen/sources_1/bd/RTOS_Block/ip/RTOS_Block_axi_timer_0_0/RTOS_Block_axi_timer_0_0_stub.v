...
//               /home/prawns/RTOS_Final/RTOS_Final.gen/sources_1/bd/RTOS_Block/ip/RTOS_Block_axi_timer_0_0/RTOS_Block_axi_timer_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "RTOS_Block_axi_timer_0_0,axi_timer,{}" *) (* core_generation_info = "RTOS_Block_axi_timer_0_0,axi_timer,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_timer,x_ipVersion=2.0,x_ipCoreRevision=36,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=artix7,C_COUNT_WIDTH=32,C_ONE_TIMER_ONLY=0,C_TRIG0_ASSERT=1,C_TRIG1_ASSERT=1,C_GEN0_ASSERT=1,C_GEN1_ASSERT=1,C_S_AXI_DATA_WIDTH=32,C_S_AXI_ADDR_WIDTH=5}" *) (* downgradeipidentifiedwarnings = "yes" *) 
(* x_core_info = "axi_timer,Vivado 2024.2.2" *) 
module RTOS_Block_axi_timer_0_0(capturetrig0, capturetrig1, generateout0, 
